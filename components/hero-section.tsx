    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-6 lg:px-12 xl:px-16 pt-24 md:pt-32">
        ...
        <div className="text-center mb-8">
          <h1 className="font-mono text-4xl md:text-6xl lg:text-7xl text-[#ffffff] mb-4" style={{ textShadow: "4px 4px 0 rgba(59,130,246,0.3)" }}>
            Join the
          </h1>
          <h1 className="font-mono text-4xl md:text-7xl lg:text-7xl text-[#ffffff] mb-6" style={{ textShadow: "4px 4px 0 rgba(30,64,175,0.4)" }}>
            Adventure
          </h1>
        </div>
